...
<div class="card overflow-hidden account-card mx-3">
    <div class="bg-primary p-4 text-white text-center position-relative">
        ...
        <p class="text-white-50 mb-4">Sign in to continue to Dashboard.</p><a href="index.html"
...
<div class="m-t-40 text-center">
    <p>Don't have an account ? <a href="{{route('admin.register')}}" class="font-500 text-primary">Signup now</a></p>
