...
<div class="card overflow-hidden account-card mx-3">
    <div class="bg-primary p-4 text-white text-center position-relative">
        ...
        <p class="text-white-50 mb-4">Get your free Xplex - Dashboard account now.</p><a href="index.html"
...
<div class="m-t-40 text-center">
    <p>Already have an account ? <a href="{{route('admin.login')}}" class="font-500 text-primary">Login</a></p>
